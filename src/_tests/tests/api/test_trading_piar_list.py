...
class TestTradingPairViewSet:
    ...
    def test_authenticated_user_with_filter(
        ...
        response = api_client.get(self.url, {'base_asset__ticker': ticker})
        assert response.status_code == status.HTTP_200_OK
